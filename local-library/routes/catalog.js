...
// This has to come before the dynamic route
...
router.get('/genre/:id/update', genre_controller.genre_list_update_get);

// POST request to update a Genre
router.post('/genre/:id/update', genre_controller.genre_list_update_post);
...
router.get(
  ...
  book_instance_controller.bookinstance_list_update_get
);

// POST request to update BookInstance
router.post(
  '/bookinstance/:id/update',
  book_instance_controller.bookinstance_list_update_post
);
