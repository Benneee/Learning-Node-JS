...
var Book = require('../models/book'); // To access Book details for a genre
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      Genre.findOne(err, found_genre).exec(function(err, found_genre) {
        ...
        if (found_genre) {
          // Genre exists, redirect to the genre details page
  ...
  async.parallel(
    ...
    function(err, results) {
      ...
      if (results.genre_books.length > 0) {
        // Genre has books
        // Render the books same way as the GET route
        res.render('genre_delete', {
          title: 'Delete genre',
          genre: results.genre,
          genre_books: results.genre_books
        ...
        // Delete genre object and redirect to the list of genres page
